...
mod tests {
    ...
    fn assert_wdth_wght_test_values(fvar: &fontcull_read_fonts::tables::fvar::Fvar) {
    ...
    fn get_only_instance(
        fvar: fontcull_read_fonts::tables::fvar::Fvar,
    ) -> fontcull_read_fonts::tables::fvar::InstanceRecord {
    ...
    fn write_read_no_instances() {
        ...
        let loaded = fontcull_read_fonts::tables::fvar::Fvar::read(FontData::new(&bytes)).unwrap();
