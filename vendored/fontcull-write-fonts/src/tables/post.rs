...
impl Post {
    ...
    pub fn new_v2<'a>(order: impl IntoIterator<Item = &'a str>) -> Self {
        let standard_glyphs = fontcull_read_fonts::tables::post::DEFAULT_GLYPH_NAMES
            .iter()
            .enumerate()
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::post::PString<'a>> for PString {
    fn from_obj_ref(from: &fontcull_read_fonts::tables::post::PString<'a>, _: FontData) -> Self {
...
mod tests {
    ...
    fn compilev2() {
        ...
        let loaded = fontcull_read_fonts::tables::post::Post::read(FontData::new(&dumped)).unwrap();
