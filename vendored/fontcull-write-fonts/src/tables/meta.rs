...
impl FromObjRef<fontcull_read_fonts::tables::meta::Metadata<'_>> for Metadata {
    fn from_obj_ref(from: &fontcull_read_fonts::tables::meta::Metadata<'_>, _: FontData) -> Self {
        match from {
            fontcull_read_fonts::tables::meta::Metadata::ScriptLangTags(var_len_array) => {
                Self::ScriptLangTags(
                    var_len_array
                        .iter()
                        .flat_map(|x| {
...
impl FromTableRef<fontcull_read_fonts::tables::meta::Metadata<'_>> for Metadata {}
