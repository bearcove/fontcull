...
impl FromObjRef<fontcull_read_fonts::tables::glyf::SimpleGlyph<'_>> for SimpleGlyph {
    fn from_obj_ref(
        from: &fontcull_read_fonts::tables::glyf::SimpleGlyph,
...
///
/// Similar to fontcull_read_fonts::tables::glyf::CurvePoint, but uses kurbo::Point directly
